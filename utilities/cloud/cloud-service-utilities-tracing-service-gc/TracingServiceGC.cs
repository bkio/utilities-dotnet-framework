    ...
    public class TracingServiceGC : ITracingServiceInterface
    {
            ...
            Action<string> _ErrorMessageAction = null)
        {
            ...
            try
            {
                ...
                {
                    _ErrorMessageAction?.Invoke("TracingServiceGC->Constructor: GOOGLE_APPLICATION_CREDENTIALS (or GOOGLE_PLAIN_CREDENTIALS) environment variable is not defined.");
