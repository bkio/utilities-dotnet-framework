...
namespace CloudConnectors
{
    ...
    /// 
    /// <para>GOOGLE_CLOUD_PROJECT_ID, GOOGLE_CLOUD_COMPUTE_ZONE, GOOGLE_APPLICATION_CREDENTIALS (or GOOGLE_PLAIN_CREDENTIALS or GOOGLE_BASE64_CREDENTIALS) must be provided and valid.</para>
    /// 
    /// </summary>
